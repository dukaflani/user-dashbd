...
// Project Imports
import { getUserEvents } from "@/axios/axios"
...
const EventsPageContent = () => {
    ...
    () => [
        ...
        },
        {
            ...
            type: 'actions', 
            width: 150,
            renderCell: (params) => <EventsActions {...{params, handleOpenEditEvent, handleOpenViewEvent}} />
        }
        ], [])
    ...
    <>
        ...
        >
            ...
            <Box>
                <Container maxWidth="md">
                    <Box sx={{ width: '100%', paddingY: 10 }}>
                        <EditEventCard  editEventObject={editEventObject}  />
                    </Box>
                </Container>
            </Box>
      </Dialog>
